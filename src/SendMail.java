...
public class SendMail {
    ...
    public static void main(String[] args) throws AddressException,MessagingException {
        ...
        // 设置发件人邮箱地址
        message.setFrom(new InternetAddress("2805274695@qq.com"));
        // 设置收件人邮箱地址
//        message.setRecipients(Message.RecipientType.TO, new InternetAddress[]{new InternetAddress("2805274695@qq.com"),new InternetAddress("2805274695@qq.com"),new InternetAddress("2805274695@qq.com")});
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("2805274695@qq.com"));//一个收件人
        // 设置邮件标题
        ...
        // 连接自己的邮箱账户
        transport.connect("2805274695@qq.com", "jkempyqfbsawdghi");// 密码为QQ邮箱开通的stmp服务后得到的客户端授权码
        // 发送邮件
